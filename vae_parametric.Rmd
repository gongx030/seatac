...
#latent_dim <- 2; epochs <- 20; type <- 'vae_imputation'
#latent_dim <- 2; epochs <- 20; type <- 'vae_imputation_gmm'
#latent_dim <- 2; epochs <- 10; type <- 'vae_knn'
#latent_dim <- 2; epochs <- 10; type <- 'vae_output_fragment_size_position'
#latent_dim <- 2; epochs <- 10; type <- 'vae_output_fragment_size_position_with_imputation'
#latent_dim <- 2; epochs <- 10; type <- 'vae_fragment_size_position_baseline'
#latent_dim <- 2; epochs <- 10; type <- 'vae_fragment_size_position_gmm'
#latent_dim <- 2; epochs <- 10; type <- 'vae_fragment_size_position_cnn_encoder'
#latent_dim <- 5; epochs <- 10; type <- 'vae_fragment_size_position_cnn_encoder_gmm'
#latent_dim <- 2; epochs <- 10; type <- 'vae_fragment_size_position_cnn_encoder_with_imputation'
#latent_dim <- 2; epochs <- 10; type <- 'vae_fragment_size_position_mixture_cnn_gmm'
#latent_dim <- 2; epochs <- 10; type <- 'vae_fragment_size_position_mixture_cnn'
#latent_dim <- 2; epochs <- 10; type <- 'vae_fragment_size_position_cnn_with_imputation'
#latent_dim <- 10; epochs <- 10; type <- 'vae_fragment_size_gmm'
#latent_dim <- 5; epochs <- 10; type <- 'vae_fragment_size'
#latent_dim <- 2; epochs <- 10; type <- 'vae_fragment_size_position_cnn_kmeans'
#latent_dim <- 5; epochs <- 10; type <- 'vae_fragment_size_position_cnn'
#latent_dim <- 2; epochs <- 10; type <- 'vae_fragment_size_parametric'
latent_dim <- 10; epochs <- 20; type <- 'vae_baseline'
set.seed(1); devtools::load_all('analysis/seatac/packages/seatac'); model <- seatac(gr, type = type, latent_dim = latent_dim, epochs = epochs)

#set.seed(1); devtools::load_all('analysis/seatac/packages/seatac'); model <- model %>% finetuning(centers = 4, epochs = 10)
